...
describe BinarySearchTree do
  ...
  describe 'insert_contains_remove' do
    ...
    context "one of four items in bst is removed" do
      it 'other iterms are found but the removed item should not be found' do
        bst = BinarySearchTree.new
        bst.insert 1
        bst.insert 2
        bst.insert 3
        ...
        expect(bst.contains 2).to eq true
        expect(bst.contains 3).to eq true
        expect( bst.remove 5).to eq false
        expect( bst.remove 4).to eq true
        expect(bst.contains 1).to eq true
        expect(bst.contains 2).to eq true
        expect(bst.contains 3).to eq true
        ...
        expect(bst.contains 3).to eq false
        expect(bst.contains 4).to eq false
        expect( bst.remove 2).to eq true
        expect(bst.contains 1).to eq true
    ...
    context "one of three items in bst is removed" do
      it 'other iterms are found but the removed item should not be found' do
        bst = BinarySearchTree.new
        bst.insert 1
        bst.insert 2
